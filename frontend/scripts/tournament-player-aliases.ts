...
//   // Υπολογισμός πόσοι είναι οι άνθρωποι
//   const humanPlayersCount = tSettings.numberOfPlayers - tSettings.numberOfBots;
//   let botCounter = 1; 

//   // Τραβάμε το όνομα από το localStorage
//   const loggedInUser = localStorage.getItem('userName') || '';

//   for (let i = 0; i < tSettings.numberOfPlayers; ++i) {

//     // Εδώ είναι το κλειδί: 
//     // Αν το i είναι 0, θεωρούμε ΠΑΝΤΑ ότι είναι ο συνδεδεμένος χρήστης (άνθρωπος)
//     const isBotInput = i >= humanPlayersCount && i !== 0; 
...
//       botCounter++; 
//       disabledAttribute = 'disabled';
//       inputClass += ' bot-alias-input shadow-none opacity-70'; // λίγο πιο αχνό το bot
//     } else {
//       // HUMAN LOGIC
//       if (i === 0) {
//         // Ο πρώτος παίκτης είναι πάντα το Eleni5 (loggedInUser)
