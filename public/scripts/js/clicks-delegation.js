import { handleToggleUserMenu, handleOpenProfile, handleOpenSettings, handleLogOut } from "./user-menu.js";
import { handleOpenChooseMode, handleOpenSignUp, handleOpenLogIn, handleGoBackChooseMode } from "./welcome-page.js";
import { handleSubmitSignUp, handleSubmitLogIn, handleGoBackSignUp, handleGoBackLogIn } from "./auth-pages.js";
import { handleGameOptionSelect, handleGoBackTournament, handleStartGameOption } from "./choose-mode.js";
import { handleNextAfterAliases, handleGoBackPlayerAliases } from "./tournament-player-aliases.js";
import { handleStartTournament, handleGoBackGameReadyPage } from "./game-ready-page.js";
import { handleNextAfterCount } from "./tournament-player-count.js";
import { handleGoToWelcomePage } from "./winner-page.js";
import { handleConnectWallet, handleDisconnectWallet, handleWalletBackToMenu } from "./wallet-connect.js";
export function setupGlobalClicksDelegation() {
    ...
    document.addEventListener('click', (e) => {
        ...
        const menu = document.querySelector('.js-user-dropdown');
        if (actionEl) {
        ...
        const btn = document.querySelector('.js-user-menu-button');
